...
//Thread.sleep(1000);
    Assert.assertEquals(properties.getProperty("two"),driver.findElement(loc_cart).getText()); //step 4
...
public void removingProduct(){
    driver.findElement(loc_addFirstProduct).click();
    Assert.assertEquals(properties.getProperty("one"),driver.findElement(loc_cart).getText()); //step 5
